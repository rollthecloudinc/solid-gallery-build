...
import { f as L, i as x, q as I } from "@nf-internal/chunk-ZDGBXW54";
import { b as nt } from "@nf-internal/chunk-OH3XPIE7";
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    _injector;
    _renderer;
    _backdropClick = new b;
    _attachments = new b;
    _detachments = new b;
    _positionStrategy;
    _scrollStrategy;
    _locationChanges = m.EMPTY;
    _backdropRef = null;
    _detachContentMutationObserver;
    _detachContentAfterRenderRef;
    _previousHostParent;
    _keydownEvents = new b;
    _outsidePointerEvents = new b;
    _afterNextRenderRef;
...
var j = class {
    ...
    _positionChanges = new b;
    _resizeSubscription = m.EMPTY;
    _offsetX = 0;
    _offsetY = 0;
    ...
    dispose() { this._isDisposed || (this._boundingBox && w(this._boundingBox.style, { top: "", left: "", right: "", bottom: "", height: "", width: "", alignItems: "", justifyContent: "" }), this._pane && this._resetOverlayElementStyles(), this._overlayRef && this._overlayRef.hostElement.classList.remove(_t), this.detach(), this._positionChanges.complete(), this._overlayRef = this._boundingBox = null, this._isDisposed = !0); }
    ...
    } this._lastBoundingBoxSize = i, w(this._boundingBox.style, o); }
    _resetBoundingBoxStyles() { w(this._boundingBox.style, { top: "0", left: "0", right: "0", bottom: "0", height: "", width: "", alignItems: "", justifyContent: "" }); }
    _resetOverlayElementStyles() { w(this._pane.style, { top: "", left: "", bottom: "", right: "", position: "", transform: "" }); }
    _setOverlayElementStyles(t, e) { let i = {}, o = this._hasExactPosition(), n = this._hasFlexibleDimensions, r = this._overlayRef.getConfig(); if (o) {
        ...
        w(i, this._getExactOverlayY(e, t, l)), w(i, this._getExactOverlayX(e, t, l));
    }
    else
        i.position = "static"; let a = "", h = this._getOffset(e, "x"), c = this._getOffset(e, "y"); h && (a += `translateX(${h}px) `), c && (a += `translateY(${c}px)`), i.transform = a.trim(), r.maxHeight && (o ? i.maxHeight = p(r.maxHeight) : n && (i.maxHeight = "")), r.maxWidth && (o ? i.maxWidth = p(r.maxWidth) : n && (i.maxWidth = "")), w(this._pane.style, i); }
...
var Nt = (() => { class s {
    ...
    _overlayRef;
    _templatePortal;
    _backdropSubscription = m.EMPTY;
    _attachSubscription = m.EMPTY;
    _detachSubscription = m.EMPTY;
    _positionSubscription = m.EMPTY;
    _offsetX;
    _offsetY;
    _position;
    ...
    backdropClick = new O;
    positionChange = new O;
    attach = new O;
    detach = new O;
    overlayKeydown = new O;
    overlayOutsideClick = new O;
