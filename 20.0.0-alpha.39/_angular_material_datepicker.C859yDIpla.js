import { i as we } from "@nf-internal/chunk-54BKYNFQ";
import { a as Ae } from "@nf-internal/chunk-NGVFN3SM";
import { b as Z, d as J, l as ve } from "@nf-internal/chunk-WZUNYHUW";
import { c as u, d as w } from "@nf-internal/chunk-JK7FJX3L";
import { a as Ce } from "@nf-internal/chunk-D2J64VUP";
import { b as ye } from "@nf-internal/chunk-JWKF23VO";
import "@nf-internal/chunk-ZWWSQUYX";
import { f as be, g as X } from "@nf-internal/chunk-N3CMLH74";
...
import { j as R } from "@nf-internal/chunk-VZR6KEPQ";
import { b as _, k as f, z } from "@nf-internal/chunk-STIBVO4O";
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class r {
        ...
        ngAfterContentInit() { this._model && this._registerModel(this._model), R(this._startInput.stateChanges, this._endInput.stateChanges).subscribe(() => { this.stateChanges.next(void 0); }); }
        ngOnChanges(e) { Ze(e, this._dateAdapter) && this.stateChanges.next(void 0); }
...
var et = (() => { class r extends Xe {
    ...
    constructor() { super(), this._errorStateTracker = new Ce(this._defaultErrorStateMatcher, null, this._parentFormGroup, this._parentForm, this.stateChanges); }
    ...
    _validator = $.compose([...super._getValidators(), this._startValidator]);
    ...
    _validator = $.compose([...super._getValidators(), this._endValidator]);
    ...
    static \u0275fac = (() => { let e; return function (t) { return (e || (e = i.\u0275\u0275getInheritedFactory(r)))(t || r); }; })();
    static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-date-range-picker"]], exportAs: ["matDateRangePicker"], features: [i.\u0275\u0275ProvidersFeature([Xt, ea, { provide: v, useExisting: r }]), i.\u0275\u0275InheritDefinitionFeature], decls: 0, vars: 0, template: function (a, t) { }, encapsulation: 2, changeDetection: 0 });
} return r; })(), ei = (() => { class r {
    _datepicker = o(v);
    constructor() { }
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275inj = i.\u0275\u0275defineInjector({ providers: [F, na], imports: [ve, mt, rt, ft, De, Ue, da, Ge, kt] });
