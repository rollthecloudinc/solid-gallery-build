import { b as C } from "@nf-internal/chunk-PH3ET2PM";
import "@nf-internal/chunk-AKEDAABS";
import { a as v } from "@nf-internal/chunk-SVIUGILY";
import { e as x, l as O } from "@nf-internal/chunk-N26NRATF";
import { c as y } from "@nf-internal/chunk-OIQ2QPHM";
import { a as I } from "@nf-internal/chunk-G25BAKAM";
import { b as D } from "@nf-internal/chunk-OI5KCOOP";
import { c as b } from "@nf-internal/chunk-3C63DHR6";
import "@nf-internal/chunk-KQGCPFC3";
import { k as m, z as g } from "@nf-internal/chunk-STIBVO4O";
import "@nf-internal/chunk-FJYW2LMB";
import * as s from "@angular/core";
import { inject as o, ElementRef as E, TemplateRef as k, InjectionToken as N, signal as c, EventEmitter as _, computed as p, booleanAttribute as l, ChangeDetectorRef as A, QueryList as M, numberAttribute as R } from "@angular/core";
import { ControlContainer as w } from "@angular/forms";
...
var F = (() => { class i {
...
}, a = { NUMBER: "number", EDIT: "edit", DONE: "done", ERROR: "error" }, L = new N("STEPPER_GLOBAL_OPTIONS"), Q = (() => { class i {
    _stepperOptions;
    _stepper = o(f);
    ...
    static \u0275fac = function (t) { return new (t || i); };
    static \u0275cmp = s.\u0275\u0275defineComponent({ type: i, selectors: [["cdk-step"]], contentQueries: function (t, r, n) { if (t & 1 && (s.\u0275\u0275contentQuery(n, H, 5), s.\u0275\u0275contentQuery(n, w, 5)), t & 2) {
            let d;
            s.\u0275\u0275queryRefresh(d = s.\u0275\u0275loadQuery()) && (r.stepLabel = d.first), s.\u0275\u0275queryRefresh(d = s.\u0275\u0275loadQuery()) && (r._childForms = d);
        } }, viewQuery: function (t, r) { if (t & 1 && s.\u0275\u0275viewQuery(k, 7), t & 2) {
            let n;
    ...
    _groupId = o(I).getId("cdk-stepper-");
    ...
    _onKeydown(e) { let t = v(e), r = e.keyCode, n = this._keyManager; n?.activeItemIndex != null && !t && (r === 32 || r === 13) ? (this.selectedIndex = n.activeItemIndex, e.preventDefault()) : n?.setFocusOrigin("keyboard").onKeydown(e); }
    ...
    _containsFocus() { let e = this._elementRef.nativeElement, t = y(); return e === t || e.contains(t); }
    ...
    static \u0275dir = s.\u0275\u0275defineDirective({ type: i, selectors: [["", "cdkStepper", ""]], contentQueries: function (t, r, n) { if (t & 1 && (s.\u0275\u0275contentQuery(n, Q, 5), s.\u0275\u0275contentQuery(n, F, 5)), t & 2) {
        ...
        } }, inputs: { linear: [2, "linear", "linear", l], selectedIndex: [2, "selectedIndex", "selectedIndex", R], selected: "selected", orientation: "orientation" }, outputs: { selectionChange: "selectionChange", selectedIndexChange: "selectedIndexChange" }, exportAs: ["cdkStepper"] });
} return i; })(), de = (() => { class i {
    _stepper = o(f);
    type = "submit";
    constructor() { }
    ...
    static \u0275inj = s.\u0275\u0275defineInjector({ imports: [D] });
} return i; })();
export { Q as CdkStep, F as CdkStepHeader, H as CdkStepLabel, f as CdkStepper, ce as CdkStepperModule, de as CdkStepperNext, ae as CdkStepperPrevious, L as STEPPER_GLOBAL_OPTIONS, a as STEP_STATE, S as StepperSelectionEvent };
