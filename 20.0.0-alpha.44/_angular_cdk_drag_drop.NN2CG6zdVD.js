import { f as ut, g as $t, i as ft, p as mt } from "@nf-internal/chunk-A3W2APIK";
import "@nf-internal/chunk-OH3XPIE7";
import { a as ct, b as dt } from "@nf-internal/chunk-VP6KNDS4";
import { b as L, d as R } from "@nf-internal/chunk-OIQ2QPHM";
import "@nf-internal/chunk-DQM2BKPX";
import { a as _t } from "@nf-internal/chunk-7N7HFQKY";
import { a as gt } from "@nf-internal/chunk-G25BAKAM";
import "@nf-internal/chunk-OI5KCOOP";
import { c as G } from "@nf-internal/chunk-3C63DHR6";
import { a as pt } from "@nf-internal/chunk-FSAIB72R";
import { a as B, c as w } from "@nf-internal/chunk-JYXTBF5A";
import "@nf-internal/chunk-2A7U62US";
import "@nf-internal/chunk-PP4WNYUO";
import { c as lt, j as O } from "@nf-internal/chunk-VZR6KEPQ";
import { N as ht, b as S, f as V, k as p, l as at } from "@nf-internal/chunk-STIBVO4O";
import "@nf-internal/chunk-FJYW2LMB";
import * as d from "@angular/core";
import { signal as kt, inject as c, NgZone as J, DOCUMENT as Ot, RendererFactory2 as Lt, InjectionToken as P, ElementRef as Q, booleanAttribute as b, ViewContainerRef as Kt, ChangeDetectorRef as Nt, EventEmitter as v, Injector as Yt, afterNextRender as Xt, numberAttribute as Jt, TemplateRef as Mt } from "@angular/core";
import { takeUntil as N, map as Qt, take as te, tap as ee, switchMap as ie, startWith as At } from "rxjs/operators";
import "@angular/common";
function Z(r) { let e = r.cloneNode(!0), t = e.querySelectorAll("[id]"), i = r.nodeName.toLowerCase(); e.removeAttribute("id"); for (let s = 0; s < t.length; s++)
    t[s].removeAttribute("id"); return i === "canvas" ? wt(r, e) : (i === "input" || i === "select" || i === "textarea") && Dt(r, e), vt("canvas", r, e, wt), vt("input, textarea, select", r, e, Dt), e; }
function vt(r, e, t, i) { let s = e.querySelectorAll(r); if (s.length) {
    let n = t.querySelectorAll(r);
    for (let o = 0; o < s.length; o++)
        i(s[o], n[o]);
} }
var se = 0;
function Dt(r, e) { e.type !== "file" && (e.value = r.value), e.type === "radio" && e.name && (e.name = `mat-clone-${e.name}-${se++}`); }
function wt(r, e) { let t = e.getContext("2d"); if (t)
    try {
        t.drawImage(r, 0, 0);
    }
    catch { } }
function tt(r) { let e = r.getBoundingClientRect(); return { top: e.top, right: e.right, bottom: e.bottom, left: e.left, width: e.width, height: e.height, x: e.x, y: e.y }; }
function j(r, e, t) { let { top: i, bottom: s, left: n, right: o } = r; return t >= i && t <= s && e >= n && e <= o; }
...
function bt(r, e, t, i) { let { top: s, right: n, bottom: o, left: a, width: l, height: h } = r, _ = l * e, u = h * e; return i > s - u && i < o + u && t > a - _ && t < n + _; }
var M = class {
    _document;
    positions = new Map;
    constructor(e) { this._document = e; }
    clear() { this.positions.clear(); }
    cache(e) { this.clear(), this.positions.set(this._document, { scrollPosition: this.getViewportScrollPosition() }), e.forEach(t => { this.positions.set(t, { scrollPosition: { top: t.scrollTop, left: t.scrollLeft }, clientRect: tt(t) }); }); }
    handleScroll(e) { let t = R(e), i = this.positions.get(t); if (!i)
...
function Ft(r, e) { let t = r.rootNodes; if (t.length === 1 && t[0].nodeType === e.ELEMENT_NODE)
    return t[0]; let i = e.createElement("div"); return t.forEach(s => i.appendChild(s)), i; }
function et(r, e, t) { for (let i in e)
    if (e.hasOwnProperty(i)) {
        let s = e[i];
        s ? r.setProperty(i, s, t?.has(i) ? "important" : "") : r.removeProperty(i);
    } return r; }
function y(r, e) { let t = e ? "" : "none"; et(r.style, { "touch-action": e ? "" : "none", "-webkit-user-drag": e ? "" : "none", "-webkit-tap-highlight-color": e ? "" : "transparent", "user-select": t, "-ms-user-select": t, "-webkit-user-select": t, "-moz-user-select": t }); }
function Pt(r, e, t) { et(r.style, { position: e ? "" : "fixed", top: e ? "" : "0", opacity: e ? "" : "0", left: e ? "" : "-999em" }, t); }
function A(r, e) { return e && e != "none" ? r + " " + e : r; }
function St(r, e) { r.style.width = `${e.width}px`, r.style.height = `${e.height}px`, r.style.transform = C(e.left, e.top); }
function C(r, e) { return `translate3d(${Math.round(r)}px, ${Math.round(e)}px, 0)`; }
function yt(r) { let e = r.toLowerCase().indexOf("ms") > -1 ? 1 : 1e3; return parseFloat(r) * e; }
function re(r) { let e = getComputedStyle(r), t = U(e, "transition-property"), i = t.find(a => a === "transform" || a === "all"); if (!i)
    return 0; let s = t.indexOf(i), n = U(e, "transition-duration"), o = U(e, "transition-delay"); return yt(n[s]) + yt(o[s]); }
function U(r, e) { return r.getPropertyValue(e).split(",").map(i => i.trim()); }
var oe = new Set(["position"]), q = class {
    _document;
    _rootElement;
    _direction;
    _initialDomRect;
    ...
    attach(e) { this._preview = this._createPreview(), e.appendChild(this._preview), Rt(this._preview) && this._preview.showPopover(); }
    ...
    _createPreview() { let e = this._previewTemplate, t = this._previewClass, i = e ? e.template : null, s; if (i && e) {
        ...
        o.detectChanges(), s = Ft(o, this._document), this._previewEmbeddedView = o, e.matchSize ? St(s, n) : s.style.transform = C(this._pickupPositionOnPage.x, this._pickupPositionOnPage.y);
    }
    else
        s = Z(this._rootElement), St(s, this._initialDomRect), this._initialTransform && (s.style.transform = this._initialTransform); return et(s.style, { "pointer-events": "none", margin: Rt(s) ? "0 auto 0 0" : "0", position: "fixed", top: "0", left: "0", "z-index": this._zIndex + "" }, oe), y(s, !1), s.classList.add("cdk-drag-preview"), s.setAttribute("popover", "manual"), s.setAttribute("dir", this._direction), t && (Array.isArray(t) ? t.forEach(n => s.classList.add(n)) : s.classList.add(t)), s; }
};
function Rt(r) { return "showPopover" in r; }
var ae = { passive: !0 }, Et = { passive: !1 }, le = { passive: !1, capture: !0 }, he = 800, It = "cdk-drag-placeholder", xt = new Set(["position"]), $ = class {
    _config;
    _document;
    _ngZone;
    _viewportRuler;
    ...
    _pointerMoveSubscription = S.EMPTY;
    _pointerUpSubscription = S.EMPTY;
    _scrollSubscription = S.EMPTY;
    _resizeSubscription = S.EMPTY;
    _lastTouchEventTime;
    _dragStartTime;
    ...
    set disabled(e) { e !== this._disabled && (this._disabled = e, this._toggleNativeDragInteractions(), this._handles.forEach(t => y(t, e))); }
    _disabled = !1;
    beforeStarted = new p;
    started = new p;
    released = new p;
    ...
    data;
    constrainPosition;
    constructor(e, t, i, s, n, o, a) { this._config = t, this._document = i, this._ngZone = s, this._viewportRuler = n, this._dragDropRegistry = o, this._renderer = a, this.withRootElement(e).withParent(t.parentDragRef || null), this._parentPositions = new M(i), o.registerDragItem(this); }
    ...
    withHandles(e) { this._handles = e.map(i => w(i)), this._handles.forEach(i => y(i, this.disabled)), this._toggleNativeDragInteractions(); let t = new Set; return this._disabledHandles.forEach(i => { this._handles.indexOf(i) > -1 && t.add(i); }), this._disabledHandles = t, this; }
    ...
    withRootElement(e) { let t = w(e); if (t !== this._rootElement) {
        ...
        this._rootElementCleanups = this._ngZone.runOutsideAngular(() => [i.listen(t, "mousedown", this._pointerDown, Et), i.listen(t, "touchstart", this._pointerDown, ae), i.listen(t, "dragstart", this._nativeDragStart, Et)]), this._initialTransform = void 0, this._rootElement = t;
    ...
    disableHandle(e) { !this._disabledHandles.has(e) && this._handles.indexOf(e) > -1 && (this._disabledHandles.add(e), y(e, !0)); }
    enableHandle(e) { this._disabledHandles.has(e) && (this._disabledHandles.delete(e), y(e, this.disabled)); }
    ...
    _startDragSequence(e) { E(e) && (this._lastTouchEventTime = Date.now()), this._toggleNativeDragInteractions(); let t = this._getShadowRoot(), i = this._dropContainer; if (t && this._ngZone.runOutsideAngular(() => { this._cleanupShadowRootSelectStart = this._renderer.listen(t, "selectstart", ce, le); }), i) {
        ...
        n.insertBefore(a, s), this._initialTransform = s.style.transform || "", this._preview = new q(this._document, this._rootElement, this._direction, this._initialDomRect, this._previewTemplate || null, this.previewClass || null, this._pickupPositionOnPage, this._initialTransform, this._config.zIndex || 1e3, this._renderer), this._preview.attach(this._getPreviewInsertionPoint(n, t)), Pt(s, !1, xt), this._document.body.appendChild(n.replaceChild(o, s)), this.started.next({ source: this, event: e }), i.start(), this._initialContainer = i, this._initialIndex = i.getItemIndex(this);
    }
    else
    ...
    _initializeDragSequence(e, t) { this._parentDragRef && t.stopPropagation(); let i = this.isDragging(), s = E(t), n = !s && t.button !== 0, o = this._rootElement, a = R(t), l = !s && this._lastTouchEventTime && this._lastTouchEventTime + he > Date.now(), h = s ? dt(t) : ct(t); if (a && a.draggable && t.type === "mousedown" && t.preventDefault(), i || n || l || h)
    ...
    _animatePreviewToPlaceholder() { if (!this._hasMoved)
        return Promise.resolve(); let e = this._placeholder.getBoundingClientRect(); this._preview.addClass("cdk-drag-animating"), this._applyPreviewTransform(e.left, e.top); let t = this._preview.getTransitionDuration(); return t === 0 ? Promise.resolve() : this._ngZone.runOutsideAngular(() => new Promise(i => { let s = a => { (!a || this._preview && R(a) === this._preview.element && a.propertyName === "transform") && (o(), i(), clearTimeout(n)); }, n = setTimeout(s, t * 1.5), o = this._preview.addEventListener("transitionend", s); })); }
    _createPlaceholderElement() { let e = this._placeholderTemplate, t = e ? e.template : null, i; return t ? (this._placeholderRef = e.viewContainer.createEmbeddedView(t, e.context), this._placeholderRef.detectChanges(), i = Ft(this._placeholderRef, this._document)) : i = Z(this._rootElement), i.style.pointerEvents = "none", i.classList.add(It), i; }
    _getPointerPositionInElement(e, t, i) { let s = t === this._rootElement ? null : t, n = s ? s.getBoundingClientRect() : e, o = E(i) ? i.targetTouches[0] : i, a = this._getViewportScrollPosition(), l = o.pageX - n.left - a.left, h = o.pageY - n.top - a.top; return { x: n.left - e.left + l, y: n.top - e.top + h }; }
    _getPointerPositionOnPage(e) { let t = this._getViewportScrollPosition(), i = E(e) ? e.touches[0] || e.changedTouches[0] || { pageX: 0, pageY: 0 } : e, s = i.pageX - t.left, n = i.pageY - t.top; if (this._ownerSVGElement) {
    ...
    _getConstrainedPointerPosition(e) { let t = this._dropContainer ? this._dropContainer.lockAxis : null, { x: i, y: s } = this.constrainPosition ? this.constrainPosition(e, this, this._initialDomRect, this._pickupPositionInElement) : e; if (this.lockAxis === "x" || t === "x" ? s = this._pickupPositionOnPage.y - (this.constrainPosition ? this._pickupPositionInElement.y : 0) : (this.lockAxis === "y" || t === "y") && (i = this._pickupPositionOnPage.x - (this.constrainPosition ? this._pickupPositionInElement.x : 0)), this._boundaryRect) {
        let { x: n, y: o } = this.constrainPosition ? { x: 0, y: 0 } : this._pickupPositionInElement, a = this._boundaryRect, { width: l, height: h } = this._getPreviewRect(), _ = a.top + o, u = a.bottom - (h - o), D = a.left + n, H = a.right - (l - n);
        i = Ct(i, D, H), s = Ct(s, _, u);
    } return { x: i, y: s }; }
    ...
    _toggleNativeDragInteractions() { if (!this._rootElement || !this._handles)
        return; let e = this._handles.length > 0 || !this.isDragging(); e !== this._nativeInteractionsEnabled && (this._nativeInteractionsEnabled = e, y(this._rootElement, e)); }
    _removeRootElementListeners() { this._rootElementCleanups?.forEach(e => e()), this._rootElementCleanups = void 0; }
    _applyRootElementTransform(e, t) { let i = 1 / this.scale, s = C(e * i, t * i), n = this._rootElement.style; this._initialTransform == null && (this._initialTransform = n.transform && n.transform != "none" ? n.transform : ""), n.transform = A(s, this._initialTransform); }
    _applyPreviewTransform(e, t) { let i = this._previewTemplate?.template ? void 0 : this._initialTransform, s = C(e, t); this._preview.setTransform(A(s, i)); }
    ...
    _getDragStartDelay(e) { let t = this.dragStartDelay; return typeof t == "number" ? t : E(e) ? t.touch : t ? t.mouse : 0; }
    ...
    _getShadowRoot() { return this._cachedShadowRoot === void 0 && (this._cachedShadowRoot = L(this._rootElement)), this._cachedShadowRoot; }
    ...
    _conditionallyInsertAnchor(e, t, i) { if (e === this._initialContainer)
        ...
        let s = this._anchor ??= Z(this._placeholder);
        s.classList.remove(It), s.classList.add("cdk-drag-anchor"), s.style.transform = "", i ? i.before(s) : w(t.element).appendChild(s);
    } }
};
function Ct(r, e, t) { return Math.max(e, Math.min(t, r)); }
function E(r) { return r.type[0] === "t"; }
function ce(r) { r.preventDefault(); }
function Ht(r, e, t) { let i = T(e, r.length - 1), s = T(t, r.length - 1); if (i === s)
...
var F = class {
    ...
    sort(e, t, i, s) { let n = this._itemPositions, o = this._getItemIndexFromPointerPosition(e, t, i, s); if (o === -1 && n.length > 0)
        return null; let a = this.orientation === "horizontal", l = n.findIndex(f => f.drag === e), h = n[o], _ = n[l].clientRect, u = h.clientRect, D = l > o ? 1 : -1, H = this._getItemOffsetPx(_, u, D), Zt = this._getSiblingOffsetPx(l, n, D), jt = n.slice(); return Ht(n, l, o), n.forEach((f, qt) => { if (jt[qt] === f)
        return; let nt = f.drag === e, z = nt ? H : Zt, rt = nt ? e.getPlaceholderElement() : f.drag.getRootElement(); f.offset += z; let ot = Math.round(f.offset * (1 / f.drag.scale)); a ? (rt.style.transform = A(`translate3d(${ot}px, 0, 0)`, f.initialTransform), x(f.clientRect, 0, z)) : (rt.style.transform = A(`translate3d(0, ${ot}px, 0)`, f.initialTransform), x(f.clientRect, z, 0)); }), this._previousSwap.overlaps = j(u, t, i), this._previousSwap.drag = h.drag, this._previousSwap.delta = a ? s.x : s.y, { previousIndex: l, currentIndex: o }; }
    ...
    _cacheItemPositions() { let e = this.orientation === "horizontal"; this._itemPositions = this._activeDraggables.map(t => { let i = t.getVisibleElement(); return { drag: t, offset: 0, initialTransform: i.style.transform || "", clientRect: tt(i) }; }).sort((t, i) => e ? t.clientRect.left - i.clientRect.left : t.clientRect.top - i.clientRect.top); }
    ...
    sort(e, t, i, s) { let n = this._getItemIndexFromPointerPosition(e, t, i), o = this._previousSwap; if (n === -1 || this._activeItems[n] === e)
        ...
        return null; let l = this.getItemIndex(e), h = e.getPlaceholderElement(), _ = a.getRootElement(); n > l ? _.after(h) : _.before(h), Ht(this._activeItems, l, n); let u = this._getRootNode().elementFromPoint(t, i); return o.deltaX = s.x, o.deltaY = s.y, o.drag = a, o.overlaps = _ === u || _.contains(u), { previousIndex: l, currentIndex: n }; }
    ...
    _getRootNode() { return this._rootNode || (this._rootNode = L(this._element) || this._document), this._rootNode; }
...
}, Tt = .05, zt = .05, m = (function (r) { return r[r.NONE = 0] = "NONE", r[r.UP = 1] = "UP", r[r.DOWN = 2] = "DOWN", r; })(m || {}), g = (function (r) { return r[r.NONE = 0] = "NONE", r[r.LEFT = 1] = "LEFT", r[r.RIGHT = 2] = "RIGHT", r; })(g || {}), Y = class {
    _dragDropRegistry;
    _ngZone;
    _viewportRuler;
    element;
    ...
    _viewportScrollSubscription = S.EMPTY;
    ...
    _initialScrollSnap;
    _direction = "ltr";
    constructor(e, t, i, s, n) { this._dragDropRegistry = t, this._ngZone = s, this._viewportRuler = n; let o = this.element = w(e); this._document = i, this.withOrientation("vertical").withElementContainer(o), t.registerDropContainer(this), this._parentPositions = new M(i); }
    ...
    withDirection(e) { return this._direction = e, this._sortStrategy instanceof F && (this._sortStrategy.direction = e), this; }
    connectedTo(e) { return this._siblings = e.slice(), this; }
    withOrientation(e) { if (e === "mixed")
        this._sortStrategy = new K(this._document, this._dragDropRegistry);
    else {
        let t = new F(this._dragDropRegistry);
    ...
    _sortItem(e, t, i, s) { if (this.sortingDisabled || !this._domRect || !bt(this._domRect, Tt, t, i))
    ...
    _startScrollingIfNecessary(e, t) { if (this.autoScrollDisabled)
        return; let i, s = m.NONE, n = g.NONE; if (this._parentPositions.positions.forEach((o, a) => { a === this._document || !o.clientRect || i || bt(o.clientRect, Tt, e, t) && ([s, n] = de(a, o.clientRect, this._direction, e, t), (s || n) && (i = a)); }), !s && !n) {
        let { width: o, height: a } = this._viewportRuler.getViewportSize(), l = { width: o, height: a, top: 0, right: o, bottom: a, left: 0 };
        s = Vt(l, t), n = Bt(l, e), i = window;
    ...
    _startScrollInterval = () => { this._stopScrolling(), ht(0, lt).pipe(N(this._stopScrollTimers)).subscribe(() => { let e = this._scrollNode, t = this.autoScrollStep; this._verticalScrollDirection === m.UP ? e.scrollBy(0, -t) : this._verticalScrollDirection === m.DOWN && e.scrollBy(0, t), this._horizontalScrollDirection === g.LEFT ? e.scrollBy(-t, 0) : this._horizontalScrollDirection === g.RIGHT && e.scrollBy(t, 0); }); };
    _isOverContainer(e, t) { return this._domRect != null && j(this._domRect, e, t); }
    _getSiblingContainerFromPosition(e, t, i) { return this._siblings.find(s => s._canReceive(e, t, i)); }
    _canReceive(e, t, i) { if (!this._domRect || !j(this._domRect, t, i) || !this.enterPredicate(e, this))
...
function Vt(r, e) { let { top: t, bottom: i, height: s } = r, n = s * zt; return e >= t - n && e <= t + n ? m.UP : e >= i - n && e <= i + n ? m.DOWN : m.NONE; }
function Bt(r, e) { let { left: t, right: i, width: s } = r, n = s * zt; return e >= t - n && e <= t + n ? g.LEFT : e >= i - n && e <= i + n ? g.RIGHT : g.NONE; }
function de(r, e, t, i, s) { let n = Vt(e, s), o = Bt(e, i), a = m.NONE, l = g.NONE; if (n) {
    let h = r.scrollTop;
...
var I = { capture: !0 }, W = { passive: !1, capture: !0 }, _e = (() => {
    class r {
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    _document = c(Ot);
    _styleLoader = c(_t);
    _renderer = c(Lt).createRenderer(null, null);
    _cleanupDocumentTouchmove;
    _scroll = new p;
    _dropInstances = new Set;
    _dragInstances = new Set;
    _activeDragInstances = kt([]);
    _globalListeners;
    ...
    registerDragItem(t) { this._dragInstances.add(t), this._dragInstances.size === 1 && this._ngZone.runOutsideAngular(() => { this._cleanupDocumentTouchmove?.(), this._cleanupDocumentTouchmove = this._renderer.listen(this._document, "touchmove", this._persistentTouchmoveListener, W); }); }
    ...
    startDragging(t, i) { if (!(this._activeDragInstances().indexOf(t) > -1) && (this._styleLoader.load(_e), this._activeDragInstances.update(s => [...s, t]), this._activeDragInstances().length === 1)) {
        let s = i.type.startsWith("touch"), n = a => this.pointerUp.next(a), o = [["scroll", a => this._scroll.next(a), I], ["selectstart", this._preventDefaultWhileDragging, W]];
        s ? o.push(["touchend", n, I], ["touchcancel", n, I]) : o.push(["mouseup", n, I]), s || o.push(["mousemove", a => this.pointerMove.next(a), W]), this._ngZone.runOutsideAngular(() => { this._globalListeners = o.map(([a, l, h]) => this._renderer.listen(this._document, a, l, h)); });
    } }
    ...
    scrolled(t) { let i = [this._scroll]; return t && t !== this._document && i.push(new V(s => this._ngZone.runOutsideAngular(() => { let n = this._renderer.listen(t, "scroll", o => { this._activeDragInstances().length && s.next(o); }, I); return () => { n(); }; }))), O(...i); }
...
} return r; })(), pe = { dragStartThreshold: 5, pointerDirectionChangeThreshold: 5 }, st = (() => { class r {
    _document = c(Ot);
    _ngZone = c(J);
    _viewportRuler = c(ft);
    _dragDropRegistry = c(it);
    _renderer = c(Lt).createRenderer(null, null);
    constructor() { }
    createDrag(t, i = pe) { return new $(t, i, this._document, this._ngZone, this._viewportRuler, this._dragDropRegistry, this._renderer); }
    createDropList(t) { return new Y(t, this._dragDropRegistry, this._document, this._ngZone, this._viewportRuler); }
    static \u0275fac = function (i) { return new (i || r); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac, providedIn: "root" });
} return r; })(), k = new P("CDK_DRAG_PARENT");
var Gt = new P("CdkDragHandle"), He = (() => { class r {
    element = c(Q);
    ...
    static \u0275fac = function (i) { return new (i || r); };
    static \u0275dir = d.\u0275\u0275defineDirective({ type: r, selectors: [["", "cdkDragHandle", ""]], hostAttrs: [1, "cdk-drag-handle"], inputs: { disabled: [2, "cdkDragHandleDisabled", "disabled", b] }, features: [d.\u0275\u0275ProvidersFeature([{ provide: Gt, useExisting: r }])] });
} return r; })(), Ut = new P("CDK_DRAG_CONFIG"), Wt = new P("CdkDropList"), ze = (() => { class r {
    element = c(Q);
    dropContainer = c(Wt, { optional: !0, skipSelf: !0 });
    _ngZone = c(J);
    _viewContainerRef = c(Kt);
    _dir = c(G, { optional: !0 });
    _changeDetectorRef = c(Nt);
    _selfHandle = c(Gt, { optional: !0, self: !0 });
    _parentDrag = c(k, { optional: !0, skipSelf: !0 });
    _dragDropRegistry = c(it);
    _destroyed = new p;
    _handles = new at([]);
    ...
    exited = new v;
    dropped = new v;
    moved = new V(t => { let i = this._dragRef.moved.pipe(Qt(s => ({ source: this, pointerPosition: s.pointerPosition, event: s.event, delta: s.delta, distance: s.distance }))).subscribe(t); return () => { i.unsubscribe(); }; });
    _injector = c(Yt);
    constructor() { let t = this.dropContainer, i = c(Ut, { optional: !0 }), s = c(st); this._dragRef = s.createDrag(this.element, { dragStartThreshold: i && i.dragStartThreshold != null ? i.dragStartThreshold : 5, pointerDirectionChangeThreshold: i && i.pointerDirectionChangeThreshold != null ? i.pointerDirectionChangeThreshold : 5, zIndex: i?.zIndex }), this._dragRef.data = this, this._dragDropRegistry.registerDirectiveNode(this.element.nativeElement, this), i && this._assignDefaults(i), t && (t.addItem(this), t._dropListRef.beforeStarted.pipe(N(this._destroyed)).subscribe(() => { this._dragRef.scale = this.scale; })), this._syncInputs(this._dragRef), this._handleEvents(this._dragRef); }
    ...
    ngAfterViewInit() { Xt(() => { this._updateRootElement(), this._setupHandlesListener(), this._dragRef.scale = this.scale, this.freeDragPosition && this._dragRef.setFreeDragPosition(this.freeDragPosition); }, { injector: this._injector }); }
...
} return r; })(), X = new P("CdkDropListGroup"), Ve = (() => { class r {
    _items = new Set;
    disabled = !1;
    ngOnDestroy() { this._items.clear(); }
    static \u0275fac = function (i) { return new (i || r); };
    static \u0275dir = d.\u0275\u0275defineDirective({ type: r, selectors: [["", "cdkDropListGroup", ""]], inputs: { disabled: [2, "cdkDropListGroupDisabled", "disabled", b] }, exportAs: ["cdkDropListGroup"], features: [d.\u0275\u0275ProvidersFeature([{ provide: X, useExisting: r }])] });
} return r; })(), Be = (() => { class r {
    element = c(Q);
    _changeDetectorRef = c(Nt);
    _scrollDispatcher = c(ut);
    _dir = c(G, { optional: !0 });
    _group = c(X, { optional: !0, skipSelf: !0 });
    _latestSortedRefs;
    _destroyed = new p;
    ...
    constructor() { let t = c(st), i = c(Ut, { optional: !0 }); this._dropListRef = t.createDropList(this.element), this._dropListRef.data = this, i && this._assignDefaults(i), this._dropListRef.enterPredicate = (s, n) => this.enterPredicate(s.data, n.data), this._dropListRef.sortPredicate = (s, n, o) => this.sortPredicate(s, n.data, o.data), this._setupInputSyncSubscription(this._dropListRef), this._handleEvents(this._dropListRef), r._dropLists.push(this), this._group && this._group._items.add(this); }
    ...
    _setupInputSyncSubscription(t) { this._dir && this._dir.change.pipe(At(this._dir.value), N(this._destroyed)).subscribe(i => t.withDirection(i)), t.beforeStarted.subscribe(() => { let i = pt(this.connectedTo).map(s => { if (typeof s == "string") {
...
var We = (() => { class r {
    ...
    static \u0275inj = d.\u0275\u0275defineInjector({ providers: [st], imports: [mt] });
} return r; })();
export { Ut as CDK_DRAG_CONFIG, Gt as CDK_DRAG_HANDLE, k as CDK_DRAG_PARENT, ue as CDK_DRAG_PLACEHOLDER, ge as CDK_DRAG_PREVIEW, Wt as CDK_DROP_LIST, X as CDK_DROP_LIST_GROUP, ze as CdkDrag, He as CdkDragHandle, Ue as CdkDragPlaceholder, Ge as CdkDragPreview, Be as CdkDropList, Ve as CdkDropListGroup, st as DragDrop, We as DragDropModule, it as DragDropRegistry, $ as DragRef, Y as DropListRef, Fe as copyArrayItem, Ht as moveItemInArray, Ae as transferArrayItem, $t as \u0275\u0275CdkScrollable };
